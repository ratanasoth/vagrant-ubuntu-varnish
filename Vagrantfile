...
Vagrant.configure("2") do |config|
  ...
  # config.vm.network "public_network", ip:"192.168.1.200", :netmask => "255.255.255.0", bridge: "en0: Ethernet"
  ...
  config.vm.provision :shell, path: "./scripts/copy-files.sh", run: 'always'
